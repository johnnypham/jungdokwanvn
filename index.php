...
<div class="main container">
	...
	<div class="row">
		<div class="news col-md-8">
			<h3 class="title"><span>Tin tức hoạt động</span></h3>
				...
				<?php if ( $the_query->have_posts() ) : ?>
					...
					<!-- the loop -->
					<?php  while ( $the_query->have_posts() ) : $the_query->the_post();	?>
						<figure class="col-lg-6 col-sm-6"><a href="<?php the_permalink(); ?>" class="img-link"><?php the_post_thumbnail(); ?></a></figure>
							<figcaption class="col-lg-6 col-sm-6">
							<h4><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
								<?php the_excerpt(); ?>
							</figcaption>
					<?php endwhile; ?>
		...
		<?php 	$args = array('post_type'=>'post','posts_per_page' => 12,'orderby' => 'rand',);
			 	$the_query = new WP_Query( $args ); ?>
							...
							<?php  while ( $the_query->have_posts() ) : $the_query->the_post();	?>
									...
									<section class="section event-cus">
										...
										<div class="text pull-left">
											...
											<h6><?php the_title(); ?></h6>
											<p><?php//the_excerpt(); ?></p>
											<a  href="<?php the_permalink(); ?>"  class="booking">BOOKING</a>
										</div>
									</section>
							<?php endwhile; ?>
							<!-- end of the loop -->
